...
public class AirScheduleCreateService {
    ...
    @Transactional
    public Long createAirSchedule(AirScheduleRequestDto dto) {
        ...
        flightValidationService.airplaneSeatValidation(airplane.getAirplaneSeatTypes(), dto.getAirScheduleSeatRequestDtos());
        flightValidationService.availableAirlineValidation(airplane, fromAirport, toAirport);
        flightValidationService.takeOffTimeValidation(fromAirport, dto.getExpectedTakeoffDate(), dto.getExpectedTakeoffTime());
        ...
        // 좌석 정보 등록
        Set<AirScheduleSeatType> airScheduleSeatTypes = seatService.registerSeatForAirSchedule(dto.getAirScheduleSeatRequestDtos());
        ...
        return savedAirSchedule.getAirScheduleSeq();
    }



    @Transactional
    public void updateAirSchedule(Long airScheduleSeq, AirScheduleRequestDto dto) {
        ...
        airSchedule.updateAirSchedule(fromAirport, toAirport, dto.getExpectedTakeoffDate(), dto.getExpectedTakeoffTime());
    }
}
